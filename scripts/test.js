...
let recipeArray = ['Lait', 'de', 'Limonade', 'Sucre']
/* */ 
...
/* Code block 1 */ 
function methodearray(recettes, recipeArray){
    ...
    **/
    ...
    function natif(recettes, recipeArray, Args){
